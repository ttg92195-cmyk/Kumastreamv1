...
// Predefined collections for Movies - Only Universe Auto Collections with content
const MOVIE_COLLECTIONS = [
  'DC', 'Spider-Man', 'Batman', 'Saw', 'Studio Ghibli', 'Tom & Jerry', 'Despicable Me', 'Lord of the Rings'
];
