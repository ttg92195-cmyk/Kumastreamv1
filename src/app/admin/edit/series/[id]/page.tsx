...
import { ArrowLeft, Save, Loader2, Plus, X, Tv, Edit2, Trash2, Check, ChevronDown, ChevronUp, CheckCircle, Tag, Server } from 'lucide-react';
...
export default function EditSeriesPage() {
  ...
  const fetchSeries = useCallback(async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Parse series tags from tags field
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Combine series tags into tags string
        ...
        <div className="flex items-center justify-between p-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              style={saving ? {} : { backgroundColor: '#ef4444' }}
            >
              {saving ? (
                <>
        ...
        <div className="bg-gray-800/50 rounded-lg p-4 space-y-4">
          ...
          <div className="bg-gray-700/50 rounded-lg p-4 space-y-3 border border-gray-600">
            ...
            <button
              ...
              className="w-full py-2.5 bg-red-500 text-white rounded-lg text-sm font-medium flex items-center justify-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <Plus className="w-4 h-4" />
              Add Download Link
            </button>
                                          ...
                                          {editingEpisodeId === ep.id && editingIndex === link.originalIndex ? (
                                            ...
                                            <>
                                              <div className="flex items-center gap-2 flex-1 min-w-0">
                                                <span className="px-2 py-0.5 bg-red-500 text-white text-xs font-bold rounded flex-shrink-0">
                                                  {link.quality}
                                                </span>
