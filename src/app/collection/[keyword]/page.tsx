...
const COLLECTION_NAMES: Record<string, string> = {
  ...
  'godzilla x kong': 'Godzilla x Kong Universe',
  // Action & Adventure
  ...
  'the terminator': 'The Terminator Collection',
  ...
  'sicario': 'Sicario Collection',
  'rush hour': 'Rush Hour Collection',
  'rocky': 'Rocky Collection',
  'creed': 'Creed Collection',
  ...
  'spider-man: spider-verse': 'Spider-Man: Spider-Verse Collection',
  'spider-verse': 'Spider-Man: Spider-Verse Collection',
  ...
  'ant-man': 'Ant-Man Collection',
  'the wolverine': 'The Wolverine Collection',
  'wolverine': 'The Wolverine Collection',
  'venom': 'Venom Collection',
  'predator': 'Predator Collection',
  'alien': 'Alien Collection',
  'blade': 'Blade Collection',
  'the mummy': 'The Mummy Collection',
  'mummy': 'The Mummy Collection',
  'robert langdon': 'Robert Langdon Collection',
  'transformers': 'Transformers Collection',
  'the avengers': 'The Avengers Collection',
  'avengers': 'The Avengers Collection',
  // Horror & Thriller
  'saw': 'Saw Collection',
  'final destination': 'Final Destination Collection',
  'scream': 'Scream Collection',
  'evil dead': 'Evil Dead Collection',
  'annabelle': 'Annabelle Collection',
  'the hannibal lecter': 'The Hannibal Lecter Collection',
  'hannibal': 'The Hannibal Lecter Collection',
  'psycho': 'Psycho Collection',
  'terrifier': 'Terrifier Collection',
  'fear street': 'Fear Street Collection',
  'halloween': 'Halloween Collection',
  'blair witch': 'Blair Witch Collection',
  "rosemary's baby": "Rosemary's Baby Collection",
  'scary movie': 'Scary Movie Collection',
  'hocus pocus': 'Hocus Pocus Collection',
  'i know what you did last summer': 'I Know What You Did Last Summer Collection',
  'texas chainsaw massacre': 'Texas Chainsaw Massacre Collection',
  '28 days/weeks/years later': '28 Days/Weeks/Years Later Collection',
  'gremlins': 'The Gremlins Collection',
  'jaws': 'Jaws Collection',
  'x': 'X Collection',
  // Comedy
  'american pie': 'American Pie Collection',
  'the hangover': 'The Hangover Collection',
  'home alone': 'Home Alone Collection',
  'bridget jones': 'Bridget Jones Collection',
  'pitch perfect': 'Pitch Perfect Collection',
  'austin powers': 'Austin Powers Collection',
  'high school musical': 'High School Musical Collection',
  'hotel transylvania': 'Hotel Transylvania Collection',
  'diary of a wimpy kid': 'Diary of a Wimpy Kid Collection',
  'men in black': 'Men in Black Collection',
  'night at the museum': 'Night at the Museum Collection',
  'jumanji': 'Jumanji Collection',
  'paddington': 'Paddington Collection',
  ...
  'the lion king': 'The Lion King Collection',
  'frozen': 'Frozen Collection',
  'ice age': 'Ice Age Collection',
  'minions': 'Minions Collection',
  'despicable me': 'Despicable Me / Minions',
  'lilo & stitch': 'Lilo & Stitch Collection',
  'lilo and stitch': 'Lilo & Stitch Collection',
  'the little mermaid': 'The Little Mermaid Collection',
  'beauty and the beast': 'Beauty and the Beast Collection',
  'aladdin': 'Aladdin Collection',
  'tom & jerry': 'Tom & Jerry',
  'tom and jerry': 'Tom & Jerry',
  'scooby-doo': 'Scooby-Doo Collection',
  'sonic the hedgehog': 'Sonic the Hedgehog Collection',
...
const UNIVERSE_KEYWORDS: Record<string, string[]> = {
  ...
  'godzilla x kong': ['Godzilla', 'Kong', 'King Kong', 'Skull Island', 'Monarch', 'MonsterVerse'],
  'the dark knight': ['Dark Knight', 'Batman Begins', 'Dark Knight Rises'],
  'the avengers': ['Avengers', 'Avenger', 'Age of Ultron', 'Endgame', 'Infinity War'],
  'alien': ['Alien', 'Prometheus', 'Covenant', 'Alien: Covenant', 'Romulus'],
  'the hannibal lecter': ['Hannibal', 'Silence of the Lambs', 'Red Dragon', 'Hannibal Rising'],
  '28 days/weeks/years later': ['28 Days Later', '28 Weeks Later', '28 Years Later'],
  'the twilight': ['Twilight', 'New Moon', 'Eclipse', 'Breaking Dawn'],
  "shinkai's disaster trilogy": ['Your Name', 'Weathering with You', 'Suzume'],
  'the mummy': ['Mummy', 'The Mummy'],
  'the matrix': ['Matrix'],
