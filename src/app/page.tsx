          ...
          <form onSubmit={handleSearch} className="flex-1 flex items-center">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full bg-gray-800/80 text-white placeholder-gray-500 pl-10 pr-10 py-2.5 rounded-full text-sm focus:outline-none focus:ring-2 border border-gray-700 focus:border-transparent"
