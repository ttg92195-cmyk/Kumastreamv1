      ...
      <header className="sticky top-0 z-20 bg-[#0f0f0f]/95 backdrop-blur-sm border-b border-gray-800">
        <div className="flex items-center gap-3 px-4 h-14">
          <button 
            ...
            className="p-1.5 rounded-lg hover:bg-gray-800 transition-colors text-red-500"
          >
              ...
              <section>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-400 text-xs">({movies.length})</span>
                  </div>
                  <Link 
                    href="/movies" 
                  ...
                  >
                    More <ChevronRight className="w-4 h-4" aria-hidden="true" />
                  </Link>
                </div>
                <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-7 gap-2">
              ...
              <section>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-400 text-xs">({series.length})</span>
                  </div>
                  <Link 
                    href="/series" 
                    className="flex items-center gap-1 text-xs font-medium text-red-500 hover:text-red-400"
