...
export default function SeriesDetailPage() {
  ...
  const genreList = series.genres ? series.genres.split(',').filter(Boolean) : [];
      ...
      case 'detail':
        return (
          <div className="space-y-6">
            ...
            {series.casts && series.casts.length > 0 && (
              <div>
                            ...
                            <div key={ep.id} className="bg-gray-900/30">
                              ...
                              >
                                <div className="flex items-center gap-3">
                                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium" style={{ backgroundColor: `${themeColor}20`, color: themeColor }}>
                                    {ep.episode}
                                  </div>
                                            ...
                                            <div className="space-y-2">
                                              ...
                                              <div key={linkIndex} className="p-2 bg-gray-700/50 rounded flex items-center justify-between">
                                                ...
                                                <a
                                                  ...
                                                  className="px-3 py-1.5 text-white text-xs rounded font-medium flex items-center gap-1"
                                                  style={{ backgroundColor: themeColor }}
                                                >
                                          ...
                                          <div className="border-t border-gray-700 p-2 max-h-[60vh] overflow-y-auto overscroll-contain" style={{ WebkitOverflowScrolling: 'touch' }}>
                                            <div className="space-y-2">
                                              <div className="p-2 bg-gray-700/50 rounded flex items-center justify-between">
                                                ...
                                                <button className="px-3 py-1.5 text-white text-xs rounded font-medium flex items-center gap-1" style={{ backgroundColor: themeColor }}>
                                                  <Download className="w-3 h-3" />
                                                  Download
                                                </button>
                                              </div>
