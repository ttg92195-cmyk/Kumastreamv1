...
/* ─── Header (outside content Suspense → always visible) ─── */
function SeriesHeaderInner() {
    ...
    <div className="sticky top-0 z-10 bg-[#0f0f0f]/95 backdrop-blur-sm border-b border-gray-800 p-4">
      <div className="flex items-center justify-between">
        <h1 className="text-white font-bold text-xl">
          {activeFilter ? `${filterType}: ${activeFilter}` : 'Series'}
        </h1>
...
function SeriesHeaderFallback() {
  return (
    <div className="sticky top-0 z-10 bg-[#0f0f0f]/95 backdrop-blur-sm border-b border-gray-800 p-4">
      <div className="flex items-center justify-between">
        <h1 className="text-white font-bold text-xl">Series</h1>
        <div className="relative w-56">
          <input
            type="text"
            placeholder="Search series..."
