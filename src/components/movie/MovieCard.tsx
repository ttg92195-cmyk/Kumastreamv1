  ...
  return (
    <Link href={href} className="block group">
      <div className="relative aspect-[2/3] rounded-md overflow-hidden bg-gray-800">
        ...
        {qualityBadge && (
          <div className="absolute top-1 left-1 bg-red-500 text-white text-[9px] font-bold px-1 py-0.5 rounded max-w-[50px] truncate">
            {qualityBadge}
          </div>
        )}
      ...
      <div className="mt-1 px-0.5">
        <h3 className="text-white text-xs font-medium line-clamp-1 leading-tight group-hover:text-red-400 transition-colors duration-200">
          {title}
        </h3>
