...
// Memoized menu item - uses CSS classes, no inline styles
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-800">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-theme">
        ...
        {/* Admin Badge */}
        {currentAdmin && (
          <div className="mx-4 mt-4 p-3 rounded-lg border border-theme-30 bg-theme-15">
            <p className="text-sm font-medium text-theme">Admin Mode</p>
