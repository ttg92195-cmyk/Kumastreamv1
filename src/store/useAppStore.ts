...
/**
 * Debounced localStorage storage for better INP performance.
 * Delays writes by 100ms to batch multiple rapid state changes,
 * preventing main thread blocking from synchronous localStorage operations.
 */
function createDebouncedStorage(): StateStorage {
  ...
  return {
    ...
    setItem: (name: string, value: string) => {
      ...
      // Delay write by 100ms to batch multiple rapid changes
